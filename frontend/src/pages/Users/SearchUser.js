...
export default class EditUser extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        try {
            ...
            fetch('http://localhost:3000/index', {
                ...
                .then(res => res.json())
                .then(data => { this.setState({ userSearch: data }) })
                ...
                <div className='center'>
                    ...
                    <div className='informations-search'>
                        <div className='search-result'>
                            <img className='center-user-search space' src='/images/user-icon.png' alt='' />
                            <p className='s-space'>{user.name}</p>
                        </div>
                        <div className='search-result'>
                            <img className='center-user-search space' src='/images/mail-icon.png' alt='' />
                            <p className='s-space'>{user.email}</p>
                        </div>
                    </div>
    ...
    render() {
        this.showResult(this.state.userSearch)
        return (
                            ...
                            <div className='information-user'>
                                <div className='center'>
                                    <div className='apresentation-user space-bottom'>
                                        ...
                                        <p className='user-information menos'>Buscar Usuário</p>
                                    </div>
